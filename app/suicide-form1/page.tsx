  ...
  return (
    <div className="flex w-full flex-col">
      <Card className="w-full p-5 overflow-auto">
        <p className="text-lg flex justify-center font-bold">แบบคัดกรองโรคซึมเศร้า 2 คำถาม (2Q)</p>

        <div className="flex flex-col lg:flex-row justify-between py-5 px-4">
          <div className="flex flex-col lg:flex-row justify-start w-full gap-4 mt-3">
        ...
        {customer && <SuicideForm1 customer={customer} /> }
